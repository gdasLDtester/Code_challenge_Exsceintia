...
There are a total of eleven unit tests covering almost all the methods in the subsequent code.
...
import pandas as pd
from src.scientific_data_challenge import ScientificData
import filecmp
...
class TestDemo(unittest.TestCase):
    ...
    def test_dataframe(self):
        ...
        """
        # arrange
        sdf_obj = ScientificData("resources/Drugs.sdf")
        # act
    ...
    def test_sdf_sanity(self):
        ...
        with self.assertRaises(Exception) as ex:
            ScientificData("resources/fake.txt")
    ...
    def test_molecular_weight(self):
        ...
        """
        # arrange
        test = ScientificData("resources/test.sdf")
    ...
    def test_mol_images(self):
        ...
        """
        # arrange
        test = ScientificData("resources/Drugs.sdf")
        test.mol_image()
        # assert
        self.assertTrue(filecmp.cmp("resources/output_image.png", "resources/output.png", shallow=False))

    def test_invalid_mol_images(self):
        """
        UnitTest case to check if the images returned from a file is as expected.
        """
        # arrange
        ...
        test.mol_image()
        # assert
        self.assertFalse(filecmp.cmp("resources/output_image.png", "resources/google-logo-9808.png", shallow=False))
